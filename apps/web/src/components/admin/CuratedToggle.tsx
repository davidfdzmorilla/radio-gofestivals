  ...
  return (
    <button
      ...
      className={cn(
        ...
        'focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-magenta',
    ...
    >
      <span
        className={cn(
          'inline-block h-4 w-4 rounded-full bg-fg-0 shadow-sm transition-transform duration-150',
