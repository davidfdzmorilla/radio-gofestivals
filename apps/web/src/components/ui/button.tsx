...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 rounded-md font-display font-medium transition-all duration-200 focus-visible:outline-hidden disabled:opacity-50 disabled:pointer-events-none',
  {
    variants: {
      variant: {
        default:
...
// React 19: ref es una prop normal; forwardRef queda deprecado.
