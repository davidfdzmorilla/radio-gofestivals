...
from app.api.v1.users.email_verification import router as email_verification_router
...
from app.api.v1.users.plays import router as plays_router
...
users_router.include_router(email_verification_router)
users_router.include_router(favorites_router)
users_router.include_router(votes_router)
users_router.include_router(plays_router)
